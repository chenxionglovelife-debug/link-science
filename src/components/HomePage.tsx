...
import AIReportChat from './AIReportChat';
...
export default function HomePage({ onNavigate }: HomePageProps) {
  ...
  const [showAIReportTest, setShowAIReportTest] = useState(false);
  ...
  // 开发测试：按Shift+T触发AI对话框
  useEffect(() => {
    const handleKeyPress = (e: KeyboardEvent) => {
      if (e.shiftKey && e.key === 'T') {
        setShowAIReportTest(true);
        toast.info('AI对话框测试', { description: '按Shift+T可重新触发' });
      }
    };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/40 to-blue-50/40 dark:from-slate-900 dark:via-indigo-900/30 dark:to-blue-900/30">
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div className="grid grid-rows-[280px_1fr] gap-6 min-h-[860px]">
          ...
          {/* 第一行：Future 通过率预测、Banner、小链同学 */}
          <div className="grid grid-cols-12 gap-6 items-stretch">
            {/* Future 通过率预测 */}
            <div className="col-span-3" data-guide="predict-rate">
              <Card className="border-0 shadow-xl bg-gradient-to-br from-cyan-50/80 to-blue-50/80 dark:from-cyan-900/25 dark:to-blue-900/25 backdrop-blur-sm h-full min-h-[280px]">
                <CardContent className="p-6 h-full flex flex-col">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-xl">通过率预测</h3>
            ...
            {/* 小链同学 */}
            <div className="col-span-3" data-guide="ai-mascot">
                ...
                <CardContent className="p-6 h-full flex flex-col">
                  <div className="mb-4">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span className="font-semibold text-xl">小链同学</span>
                    </div>
                    <p className="text-sm text-muted-foreground">智能陪伴，个性化学习指导</p>
                  </div>
                  <div className="flex-1 flex items-center justify-center">
                    <div className="flex flex-col items-center bg-gradient-to-br from-slate-100/60 to-indigo-100/60 dark:from-slate-800/40 dark:to-indigo-800/40 rounded-xl p-4 border border-slate-200/40 dark:border-slate-700/40 cursor-pointer hover:bg-gradient-to-br hover:from-slate-100/80 hover:to-indigo-100/80 dark:hover:from-slate-800/60 dark:hover:to-indigo-800/60 transition-all duration-300">
          ...
          <div className="grid grid-cols-12 gap-6 items-stretch">
            {/* Core 赛事争锋 - 全高度 */}
            <div className="col-span-3" data-guide="contest">
            ...
            <div className="col-span-6 flex flex-col gap-6">
              {/* Neo真题练级 - 缩小高度 */}
              <Card className="border-0 shadow-xl p-6 bg-gradient-to-br from-indigo-50/80 to-purple-50/80 dark:from-indigo-900/25 dark:to-purple-900/25 backdrop-blur-sm" data-guide="exam-practice">
                <CardHeader className="p-0 mb-6">
                  <CardTitle className="flex items-center space-x-3 text-xl">
                    <Trophy className="w-7 h-7 text-indigo-600" />
                    <span>真题练级</span>
                  </CardTitle>
                  <CardDescription className="text-base mt-2">选择编程考级方向，开始练习</CardDescription>
                </CardHeader>
                <CardContent className="p-0">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <p className="text-sm text-muted-foreground">中国计算机学会</p>
                    </div>
                    <div 
                      className="p-6 rounded-xl bg-gradient-to-br from-indigo-100/70 to-purple-100/70 dark:from-indigo-800/40 dark:to-purple-800/40 hover:from-indigo-100/90 hover:to-purple-100/90 dark:hover:from-indigo-800/60 dark:hover:to-purple-800/60 hover:shadow-lg transition-all duration-300 cursor-pointer border border-indigo-200/40 dark:border-indigo-700/40 group"
                      onClick={() => onNavigate('contest')}
                    >
                      ...
                      <p className="text-sm text-muted-foreground">中国电子学会</p>
                    </div>
                    <div 
                      className="p-6 rounded-xl bg-gradient-to-br from-indigo-100/70 to-purple-100/70 dark:from-indigo-800/40 dark:to-purple-800/40 hover:from-indigo-100/90 hover:to-purple-100/90 dark:hover:from-indigo-800/60 dark:hover:to-purple-800/60 hover:shadow-lg transition-all duration-300 cursor-pointer border border-indigo-200/40 dark:border-indigo-700/40 group"
                      onClick={() => onNavigate('contest')}
              ...
              <Card className="border-0 shadow-xl p-6 bg-gradient-to-br from-emerald-50/80 to-teal-50/80 dark:from-emerald-900/25 dark:to-teal-900/25 backdrop-blur-sm flex-1 min-h-[140px]">
                ...
                <CardContent className="p-0">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-5 rounded-xl bg-gradient-to-br from-emerald-100/70 to-green-100/70 dark:from-emerald-800/40 dark:to-green-800/40 border border-emerald-200/50 dark:border-emerald-700/40">
                      <div className="text-3xl font-bold text-emerald-600 mb-2">248题</div>
                      <div className="text-sm text-muted-foreground mb-1">刷题量</div>
                      <div className="text-xs text-emerald-600">排名 #127</div>
                    </div>
                    <div className="text-center p-5 rounded-xl bg-gradient-to-br from-teal-100/70 to-cyan-100/70 dark:from-teal-800/40 dark:to-cyan-800/40 border border-teal-200/50 dark:border-teal-700/40">
                      <div className="text-3xl font-bold text-teal-600 mb-2">42小时</div>
                      <div className="text-sm text-muted-foreground mb-1">学习时长</div>
                      <div className="text-xs text-teal-600">排名 #89</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            {/* Deep练习 - 全高度，显示5套试题 */}
            <div className="col-span-3" data-guide="deep-practice">
              <Card className="border-0 shadow-xl p-8 bg-gradient-to-br from-blue-50/80 to-indigo-50/80 dark:from-blue-900/25 dark:to-indigo-900/25 backdrop-blur-sm h-full">
                <CardHeader className="p-0 mb-8">
                  ...
                  <CardDescription className="text-base">根据薄弱知识点推荐</CardDescription>
                </CardHeader>
      ...
      {/* 隐藏的AI对话框测试按钮 - 开发测试用，按Shift+T触发 */}
      <AIReportChat
        open={showAIReportTest}
        onOpenChange={setShowAIReportTest}
        score={85}
        accuracy={85}
        improvement={12}
        weakPoints={['循环结构', 'For循环']}
        onContinuePractice={() => {
          setShowAIReportTest(false);
          toast.success('开始新的练习！');
        }}
        onNewChallenge={() => {
          setShowAIReportTest(false);
          toast.success('为你挑选了新的试卷！');
        }}
        onViewReport={() => {
          setShowAIReportTest(false);
          toast.info('即将跳转到学习报告页面');
        }}
      />
    </div>
  );
